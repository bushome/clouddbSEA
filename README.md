...
| $$\  $ | $$| $$  | $$ /$$  \ $$| $$/$$ $$| $$            | $$       /$$/\  $$| $$  
| $$ \/  | $$|  $$$$$$$|  $$$$$$/|  $$$$$$/| $$$$$$$$      | $$$$$$$$| $$  \ $$| $$$$$$$$
|__/     |__/ \____  $$ \______/  \____ $$$|________/      |________/|__/  |__/|________/
              /$$  | $$                \__/  
             |  $$$$$$/  
              \______/  
```
This page contains the source files for the Stand Alone MySQL/MariaDB Executable packaging for the Cloud Dedicated Storage No-Overflow API Variant, https://github.com/bushome/ark-cloud-storage-no-overflow/releases.
...
```powershell
  Copy-Item -Recurse "C:\ARK CLOUD DEDICATED STORAGE API - No OverFlow\clouddbSEA\generated\mysql-client" "C:\ARK CLOUD DEDICATED STORAGE API - No OverFlow\clouddbSEA\build\generated\mysql-client"
```
...
```powershell
cd "C:\ARK CLOUD DEDICATED STORAGE API - No OverFlow\clouddbSEA\clouddbSEA\build"
.\clouddb-test.exe
```
